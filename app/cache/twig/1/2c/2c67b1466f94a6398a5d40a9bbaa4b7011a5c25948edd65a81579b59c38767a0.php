...
class __TwigTemplate_d06c83e35378654df57f1e45607b995f58c8efeea733ff190ad95eca7fac2127 extends Twig_Template
{
...
<section id=\"settings\">
    ";
        ...
        ";
            // line 46
            if (($this->getAttribute($context["loop"], "first", array()) || (0 == $this->getAttribute($context["loop"], "index0", array()) % ($context["columns"] ?? null)))) {
                // line 47
                echo "            <div class=\"row\">
        ";
            }
        ...
        ";
            // line 93
            if (($this->getAttribute($context["loop"], "last", array()) || (0 == $this->getAttribute($context["loop"], "index", array()) % ($context["columns"] ?? null)))) {
                // line 94
                echo "            </div>
        ";
            }
...
";
    ...
    {
        return new Twig_Source("", "default/admin/settings_index.tpl", "/var/www/html/cursos_online/main/template/default/admin/settings_index.tpl");
    }
}
